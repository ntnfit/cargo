...
<body>
  <table cellspacing="0" border="0">
    ...
    <tr>
      <td></td>
      <td></td>
      <td colspan=4 rowspan=2 align="left" valign=middle class="largeText"><b>Ngày Chuyển Hàng: {{$orders->deldate}}</b></td>
    </tr>
    <tr></tr>
    <tr></tr>
    <tr>
      ...
      <td colspan=1 height="20" align="left" valign=middle class="mediumText">
      </td>
    ...
    <tr>
      ...
      <td colspan rowspan=1 align="left" valign=middle class="largeText"</td>
    ...
    <tr>
      ...
      <td colspan=2 stypmargin-left: align="center" valign=middle class="mediumText">
        <b>Mặt Hàng</b>
      </td>
      <td></td>
    ...
    <tr>
      <td colspan=4 valign=top>
        @for ($i = 0; $i < 6; $i++)
          <div class="row">
            <div colspan='2'class="column">…...............</div>
            <div colspan='2' style="width:60%" class="column">…..............................................</div>
          </div>
        @endfor
        </td>
      ...
      <td colspan=4 valign=top>
        @for ($i = 0; $i < 6; $i++)
          <div class="row-right">
          <div colspan='2'class="column">…...............</div>
            <div colspan='2'style="width:55%" class="column">…..............................................</div>
          </div>
        @endfor
        </td>
    </tr>
    ...
    <tr>
      <td colspan=3 align="left" valign=middle class="largeText">
        <b><u>Cân Nặng :</u> {{$orders->weight}}</b>
      <td></td>
      <td class="mediumText">Subtotal:</td>
      <td align="left" class="smallText"> &nbsp;&nbsp; lb(s) x &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$</td>
      <td class="smallText">&nbsp;&nbsp;&nbsp;/lb  =</td>
