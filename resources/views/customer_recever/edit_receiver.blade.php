...
@include('layouts.headers.app')
    ...
    {!! Form::model($receivers, ['method' => 'PATCH','route' => ['receivers.update', $receivers->id]]) !!}
        @csrf
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Name:</strong>
                    <input type="text" name="name" value="{{$receivers->name}}" class="form-control" placeholder="Name">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
